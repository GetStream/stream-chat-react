...
class App extends Component {
	constructor(props) {
		...
		previousSession = previousSession != null ? JSON.parse(previousSession) : {};

		this.state = {
			channelName: 'general',
			chatType: previousSession.chatType ? previousSession.chatType : 'messaging',
					...
					<Navbar.Collapse id="basic-navbar-nav">
						<Nav className="mr-auto">
							<ButtonToolbar>
								...
								>
									<ToggleButton value={'messaging'}>
										Messaging
									</ToggleButton>
									<ToggleButton value={'team'}>Team</ToggleButton>
									<ToggleButton value={'livestream'}>
										Livestream
									</ToggleButton>
								</ToggleButtonGroup>
							</ButtonToolbar>
