  ...
  beforeEach(() => {
    ...
    it('.typesearch-negative() - type into a DOM element', () => {    
      ...
      cy.get('input[placeholder=Search]')
       ...
       .should('exist')
      cy.xpath("//div[@class='str-chat__channel-search-container inline'][contains(.,'red-dust-7dangetstreamiodaddy-dan')]")
      cy.xpath("(//div[contains(@class,'str-chat__channel-search-result ')])[3]").eq(0)
