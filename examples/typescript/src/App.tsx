...
const i18nInstance = new Streami18n({ language: 'ru' });

const App = () => (
  // <Chat client={chatClient}>
  // <Chat client={chatClient} defaultLanguage={'ru'}>
  <Chat client={chatClient} defaultLanguage={'ru'} i18nInstance={i18nInstance}>
