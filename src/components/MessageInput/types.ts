...
export type AudioAttachment<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> =
  Attachment<StreamChatGenerics> & {
    type: 'audio';
    asset_url?: string;
    file_size?: number;
...
export type VideoAttachment<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> =
  Attachment<StreamChatGenerics> & {
    type: 'video';
    asset_url?: string;
    mime_type?: string;
