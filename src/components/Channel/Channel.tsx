...
> = {
  ...
  /** Custom UI component to display the contents of a bounced message modal. Usually it allows to retry, edit, or delete the message. Defaults to and accepts the same props as: [MessageBounceOptions](https://github.com/GetStream/stream-chat-react/blob/master/src/components/MessageBounce/MessageBounceOptions.tsx) */
  MessageBounceOptions?: ComponentContextValue<StreamChatGenerics>['MessageBounceOptions'];
...
>(
  ...
  const componentContextValue: ComponentContextValue<StreamChatGenerics> = useMemo(
    () => ({
      ...
      MessageBounceOptions: props.MessageBounceOptions,
