...
class MessageList extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      notifications: [],
      // this.props.messages - messages loaded in channel
      // this.state.slicedMessages - messages loaded in DOM
      slicedMessages: [],
    };
  ...
  loadMore = () => {
    if (
      ...
      this.setState({
        slicedMessages: this.props.messages.slice(
          -(this.state.slicedMessages.length + this.props.messageLimit),
        ),
      });
      return;
    }
