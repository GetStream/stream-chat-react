...
export class MessageSimple extends PureComponent {
	...
	render() {
		...
		const images =
			hasAttachment && message.attachments.filter(item => item.type === 'image');
						...
						{message.text && (
							<div className="str-chat__message-text">
								<div
									...
									${isOnlyEmojis(message.text) ? 'str-chat__message-simple-text-inner--is-emoji' : ''}
								`.trim()}
