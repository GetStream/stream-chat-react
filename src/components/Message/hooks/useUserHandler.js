 ...
 * @type {(eventHandlers: {onUserClickHandler?: UserEventHandler, onUserHoverHandler?: UserEventHandler} , message: import('stream-chat').MessageResponse | null | undefined) => { onUserClick: Handler, onUserHover: Handler }}
 */
