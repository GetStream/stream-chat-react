  ...
  return {
    ...
    channel: {
      ...
      config: {
        ...
        connect_events: true,
        created_at: ts('2020-04-24T11:36:43.859020368Z'),
        ...
        typing_events: true,
        updated_at: ts('2020-04-24T11:36:43.859022903Z'),
        uploads: true,
        url_enrichment: true,
        ...config,
      } as ChannelConfigWithInfo,

      created_at: ts('2020-04-28T11:20:48.578147Z'),

      created_by: {
        banned: false,
        created_at: ts('2020-04-27T13:05:13.847572Z'),
        id: 'vishal',
        last_active: ts('2020-04-28T11:21:08.353026Z'),
        online: false,
        role: 'user',
        updated_at: ts('2020-04-28T11:21:08.357468Z'),
      },
      disabled: false,
      frozen: false,
      id,
      type,
      updated_at: ts('2020-04-28T11:20:48.578147Z'),
      ...restOptionsChannel,
    },
    messages,
