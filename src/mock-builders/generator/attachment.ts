...
export const generateFileAttachment = (a: Partial<Attachment> = {}) =>
  ({
    ...
    // v10: attachment-specific fields (file_size, mime_type, …) live under `custom`.
    custom: { file_size: 1337, mime_type: 'application/pdf' },
    title: nanoid() + '.pdf',
    type: 'file',
    ...a,
  }) as Attachment;
...
export const generateVideoAttachment = (a: Partial<Attachment> = {}) =>
  ({
    ...
    custom: { file_size: 2930530, mime_type: 'video/mp4' },
    thumb_url: 'thumb_url',
    title: nanoid() + '.mp4',
    type: 'video',
    ...a,
...
export const generateAudioAttachment = (a: Partial<Attachment> = {}) =>
  ({
    ...
    custom: { file_size: 36132, mime_type: 'audio/mpeg' },
    title: nanoid() + '.mpeg',
    type: 'audio',
    ...a,
  }) as Attachment;

export const generateVoiceRecordingAttachment = (a: Partial<Attachment> = {}) =>
  ({
    asset_url:
    ...
    // v10: voice-recording fields (duration, file_size, mime_type, waveform_data) live under `custom`.
    custom: {
      ...
      waveform_data: [
        ...
        0.059566497802734375, 0.032375335693359375, 0.14445610344409943,
        0.9534039497375488, 0.8612125515937805, 0.4861070513725281, 0.5025619864463806,
        0.3678266108036041, 0.5829864144325256, 0.6209651231765747, 0.6576777696609497,
        0.6046710014343262, 0.08803673088550568, 0.492523193359375, 0.1947961449623108,
        0.09975242614746094, 0.03940269351005554, 0.372602641582489, 0.4425804913043976,
        0.6269233226776123, 0.7768490314483643, 0.41689178347587585, 0.18697471916675568,
        0.11767738312482834, 0.049776915460824966, 0.1377594769001007,
        0.08291183412075043, 0.05717025697231293, 0.01960846036672592,
        0.04073379561305046, 0.2909153699874878, 0.2615521252155304, 0.1473514586687088,
        0.8678494095802307, 0.9467474222183228, 0.7687522768974304, 0.8469597101211548,
        0.6312726736068726, 0.5455475449562073, 0.8171653747558594, 0.7835009694099426,
        0.6183612942695618, 0.7298175692558289, 0.6681936383247375, 0.815593957901001,
        0.7774609327316284, 0.8033567070960999, 0.8980446457862854,
      ],
    },
...
export const generateScrapedDataAttachment = (a: Partial<Attachment> = {}) =>
  ({
...
export const generateScrapedImageAttachment = (a: Partial<Attachment> = {}) =>
  ({
...
export const generateScrapedVideoAttachment = (a: Partial<Attachment> = {}) =>
  ({
    ...generateScrapedDataAttachment({
      asset_url: nanoid(),
      author_name: nanoid(),
...
export const generateScrapedAudioAttachment = (a: Partial<Attachment> = {}) =>
  ({
    ...generateScrapedDataAttachment({
      asset_url: 'http://www.jackblack.com/tribute.mp3',
      author_name: nanoid(),
...
export const generateGiphyAttachment = (a: Partial<Attachment> = {}) =>
  ({
    giphy: {
      fixed_height: {
        frames: '',
