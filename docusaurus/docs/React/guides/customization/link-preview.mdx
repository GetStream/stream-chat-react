...
The purpose of link previews in message input is to provide visual guides of what a user may expect to be rendered later in message list by [`Card` component](../../../components/message-components/attachment#card) among message attachments.
...
const App = () => (
  <Channel  enrichURLForPreview >
    ...
    <MessageInput {...urlEnrichmentConfig } />
...
The default debounce interval is 1.5 seconds. This can be prolonged or shorten by passing `debounceURLEnrichmentMs` configuration parameter:
