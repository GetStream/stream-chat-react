...
| Type    | Default                                                                             |
| ------- | ----------------------------------------------------------------------------------- |
| boolean | [ChannelStateContextValue['hasMore']](../context/channel-state-context.mdx#hasmore) |
...
| Type    | Default                                                                                     |
| ------- | ------------------------------------------------------------------------------------------- |
| boolean | [ChannelStateContextValue['loadingMore']](../context/channel-state-context.mdx#loadingmore) |
...
| Type     | Default                                                                                 |
| -------- | --------------------------------------------------------------------------------------- |
| function | [ChannelActionContextValue['loadMore']](../context/channel-action-context.mdx#loadmore) |
...
| Type     | Default                                                              |
| -------- | -------------------------------------------------------------------- |
| function | ['edit', 'delete', 'flag', 'mute', 'pin', 'quote', 'react', 'reply'] |
...
| Type   | Default                                                                               |
| ------ | ------------------------------------------------------------------------------------- |
| number | [ChannelStateContextValue['messages']](../context/channel-state-context.mdx#messages) |
...
| Type     | Default                                                                                               |
| -------- | ----------------------------------------------------------------------------------------------------- |
| function | [ChannelActionContextValue['onMentionsClick']](../context/channel-action-context.mdx#onmentionsclick) |
...
| Type     | Default                                                                                               |
| -------- | ----------------------------------------------------------------------------------------------------- |
| function | [ChannelActionContextValue['onMentionsHover']](../context/channel-action-context.mdx#onmentionshover) |
...
| Type     | Default                                                                                     |
| -------- | ------------------------------------------------------------------------------------------- |
| function | [ChannelActionContextValue['openThread']](../context/channel-action-context.mdx#openthread) |
...
| Type     | Default                                                                                                 |
| -------- | ------------------------------------------------------------------------------------------------------- |
| function | [ChannelActionContextValue['retrySendMessage']](../context/channel-action-context.mdx#retrysendmessage) |
