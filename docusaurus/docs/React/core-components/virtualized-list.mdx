...
:::note
With the new release of the version 18 of React we highly suggest adding `react18ConcurrentRendering` as a temporary measure to your `additionalVirtuosoProps` to reduce the amount of unwanted "blinking".

```jsx
<VirtualizedMessageList additionalVirtuosoProps={{ react18ConcurrentRendering: true }} />
```

You can find more information about this issue here: [react-virtuoso #647](https://github.com/petyosi/react-virtuoso/issues/647).
:::
