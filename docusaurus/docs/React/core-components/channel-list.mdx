...
export const OnEventCallbackTypeTable = () => (
  <table>
    <tr><th>Type</th></tr>
    <tr>
      <td>
...
[//]: # (REVIEW_NOTE_START[a0523cee-2375-11ed-8530-a4bb6d26ac2f])
[//]: # (Proposing to make filters mandatory as per the below caution - At a minimum, the filter should include `{members: { $in: [userID] }}` - it is confusing to newcomers that the channels query fails due to this missing param)
...
[//]: # (REVIEW_NOTE_END[a0523cee-2375-11ed-8530-a4bb6d26ac2f])
...
[//]: # (REVIEW_NOTE_START[6bd7d78e-2542-11ed-a44c-a4bb6d26ac2f])
[//]: # (Missing example use case to better understand the purpose. The default List component does not make use of the loadedChannels prop)
### sendChannelsToList
...
|---------|---------|
| boolean | false   |
[//]: # (REVIEW_NOTE_END[6bd7d78e-2542-11ed-a44c-a4bb6d26ac2f])
