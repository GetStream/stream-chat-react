...
Whether or not to set the most recent channel received from the query as active on component mount.
...
Whether or not to load the list with a search component.
