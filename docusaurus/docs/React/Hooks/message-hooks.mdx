...
const MyCustomMessageComponent = () => {
  ...
  return (
    <div>
      {message.text} <button onClick={handleDelete}>Delete, please</button>
    </div>
  );
};
```
...
const MyCustomMessageComponent = () => {
  ...
  if (editing) {
    return <div>Editing: {message.text} <button onClick={clearEdit}>Cancel</button></div>
  }

  return (
    <div>
      {message.text} <button onClick={setEdit}>Edit</button>
    </div>
  );
};
```
...
const MyCustomMessageComponent = () => {
  ...
  return (
    <div>
      {message.text} <button onClick={handleFlagging}>Flag this message</button>
    </div>
  );
};
```
...
const MyCustomMessageComponent = () => {
  ...
  return (
    <div>
      {message.text} <button onClick={handleMute}>Mute the user that sent this!</button>
    </div>
  );
};
```
...
const MyCustomMessageComponent = (props) => {
  const { getPinMessageErrorNotification } = props;
...
<MessageList Message={() => (
    <MyCustomMessageComponent
      getPinMessageErrorNotification={customGetPinMessageErrorNotification}
  />
  )}
/>
```
