...
## Overview
The `ChannelStateContext` is a one of the context providers exposed by the `Channel` component, and the context value provides all of the state properties and logic for a `Channel`.
