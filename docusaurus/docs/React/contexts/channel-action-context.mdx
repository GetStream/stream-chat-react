...
The function to resend a `message`, handled by the `Channel` component. Takes a `message` object as the first argument and another `message` object with custom data as the second.
