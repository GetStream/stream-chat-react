...
## Overview
The `ChannelActionContext` is a one of the context providers exposed by the `Channel` component, and the context value provides all of the action properties and handlers for a `Channel`.
