...
class constructor that handles language translation.
...
If the language for the connected user is not manually set by the application, the component library detects the user's default
browser language. If the component library has translation support for the detected browser language, the connected user's language
is automatically set to this value. If the browser language is not supported for translation, the library defaults to English.
