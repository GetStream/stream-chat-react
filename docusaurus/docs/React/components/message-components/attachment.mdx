...
| `audio_recording`| [AudioRecording](https://github.com/GetStream/stream-chat-react/blob/master/src/components/Attachment/AudioRecording.tsx) | MP3, WAV, M4A, FLAC, AAC                               |
...
Custom UI component for displaying an audio_recording type attachment.

| Type      | Default                                                      |
| --------- | ------------------------------------------------------------ |
| component | <GHComponentLink text='AudioRecording' path='/Attachment/AudioRecording.tsx'/> |
...
Custom UI component for displaying unrecognized type of attachment. The default implementation of the component (`NullComponent`) does not render any content.

| Type      | Default                                                                                       |
|-----------|-----------------------------------------------------------------------------------------------|
| component | <GHComponentLink text='UnsupportedAttachment' path='/Attachment/UnsupportedAttachment.tsx' /> |
