  ...
  items={[
    {
      ...
      caption: <span>Search results list content when loading</span>,
      alt: 'Image of search results list content when loading',
    },
    {
      image: ImageSearchResultsEmptyTheme,
      caption: <span>Empty search results</span>,
  ...
  items={[
    {
      ...
      caption: <span>Search results displayed inline</span>,
      alt: 'Image of search results displayed inline',
    },
    {
      image: ImageSearchResultsPopupTheme,
      caption: <span>Search results displayed floating above the channel list</span>,
...
Custom component to be rendered instead of the default <GHComponentLink text='SearchBar' path='/ChannelSearch/SearchBar.tsx'/>. The default `SearchBar` component is a composite of multiple buttons and a search input. You can find more information about its features in an [above section](./#searchbar-component).
