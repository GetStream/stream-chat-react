...
A typical use case for the `Avatar` component would be to import and use in your custom components that will completely override a header component, preview component, or similiar.
...
<ChannelList
  Preview={(props) => <ChannelPreviewMessenger {...props} Avatar={CustomAvatar} />}
/>
```
