...
Selection of a search result will set the active channel with the selected user, or if a channel is selected, set the active channel with the existing channel.
