...
adding additional UI items, not using all of the props, and incorporating other logic that fit your requirements. Check out the [CSS section](../customization/theming-and-css.mdx) for a note on custom styling.
