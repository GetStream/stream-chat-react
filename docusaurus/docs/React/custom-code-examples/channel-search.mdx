...
To override the search method, completely use the `searchFunction` prop. This prop is useful, say, when you want to search for channels that the current
logged in user is a member of. See the example below for this.
