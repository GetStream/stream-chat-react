...
To view the list of these custom handler functions to override (if there is one), see the `ChannelList` [documentation](../core-components/channel-list.mdx/#event-listeners).
