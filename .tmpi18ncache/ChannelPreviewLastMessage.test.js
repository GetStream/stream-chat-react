...
var _ChannelPreviewLastMessage = _interopRequireDefault(
  require('../ChannelPreviewLastMessage'),
);

describe('ChannelPreviewLastMessage', function () {
  ...
  var renderComponent = function renderComponent(props) {
    return /*#__PURE__*/ _react.default.createElement(
      _ChannelPreviewLastMessage.default,
      (0, _extends2.default)(
        {
          channel: channel,
