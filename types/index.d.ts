...
interface MessageInputUIComponentProps extends MessageInputProps {
  ...
  onPaste?(event: ClipboardEventHandler): void;
  ...
  imageOrder: string[];
  imageUploads: SeamlessImmutable.Immutable<Array<ImageUpload>>;
  fileOrder: string[];
  fileUploads: SeamlessImmutable.Immutable<Array<FileUpload>>;
