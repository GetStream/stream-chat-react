...
const sampleAttachments = [imageAttachment, smallImageAttachment, svgImageAttachment, galleryAttachment, videoAttachment]
  ...
  {
    const MESSAGES_COUNT = 150;
    console.log(`Creating and populating channel '${E2E_ATTACHMENT_SIZING_CHANNEL}'...`);
    const channel = chat.channel('messaging', E2E_ATTACHMENT_SIZING_CHANNEL, {
      created_by_id: E2E_TEST_USER_1,
      members: [E2E_TEST_USER_1, E2E_TEST_USER_2],
      name: E2E_ATTACHMENT_SIZING_CHANNEL,
    });
    await channel.create();
    await channel.truncate();
