...
var Thread = /** @class */ (function (_super) {
    ...
    Thread.prototype.render = function () {
        ...
        return react_1.default.createElement(ThreadInner, __assign({}, this.props, { key: key }));
    };
    Thread.propTypes = {
        ...
        thread: prop_types_1.default.oneOfType([prop_types_1.default.object, prop_types_1.default.bool]),
        /**
         * **Available from [channel context](https://getstream.github.io/stream-chat-react/#channel)**
        ...
        /** Customized MessageInput component to used within Thread instead of default MessageInput
            ...
            ```
        */
        MessageInput: prop_types_1.default.oneOfType([prop_types_1.default.node, prop_types_1.default.func]),
    };
    Thread.defaultProps = {
        threadHasMore: true,
...
var ThreadInner = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(parentID && this.props.thread.reply_count)) return [3 /*break*/, 2];
    ...
    ThreadInner.prototype.componentDidUpdate = function (prevProps, prevState, snapshot) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(parentID &&
                            ...
                            this.props.threadMessages.length === 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.props.loadMoreThread()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
    ...
    ThreadInner.prototype.render = function () {
        ...
        var t = this.props.t;
        var read = {};
        return (react_1.default.createElement("div", { className: "str-chat__thread " + (this.props.fullWidth ? 'str-chat__thread--full' : '') },
            react_1.default.createElement("div", { className: "str-chat__thread-header" },
                react_1.default.createElement("div", { className: "str-chat__thread-header-details" },
                ...
                react_1.default.createElement("button", { onClick: function (e) { return _this.props.closeThread(e); }, className: "str-chat__square-button" },
            ...
            react_1.default.createElement("div", { className: "str-chat__thread-list", ref: this.messageList },
                react_1.default.createElement(Message_1.Message, __assign({ message: this.props.thread, initialMessage: true, threadList: true, Message: this.props.Message }, this.props, this.props.additionalParentMessageProps)),
                react_1.default.createElement("div", { className: "str-chat__thread-start" }, t('Start of a new thread')),
                react_1.default.createElement(MessageList_1.MessageList, __assign({ messages: this.props.threadMessages, read: read, threadList: true, loadMore: this.props.loadMoreThread, hasMore: this.props.threadHasMore, loadingMore: this.props.threadLoadingMore, Message: this.props.Message }, this.props.additionalMessageListProps)),
                utils_1.smartRender(this.props.MessageInput, __assign({ MessageInputSmall: MessageInputSmall_1.MessageInputSmall, parent: this.props.thread, focus: this.props.autoFocus }, this.props.additionalMessageInputProps)))));
    };
...
exports.Thread = Thread = context_1.withChannelContext(context_1.withTranslationContext(Thread));
