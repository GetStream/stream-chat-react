...
var Message = /** @class */ (function(_super) {
  ...
  function Message(props) {
    ...
    _this.isMyMessage = function(message) {
      return message.user
        ? _this.props.client.user.id === message.user.id
        : false;
    };
    ...
    _this.handleFlag = function(event) {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              ...
              (_a = this.props),
                (getFlagMessageSuccessNotification =
                  _a.getFlagMessageSuccessNotification),
                (getFlagMessageErrorNotification =
                  _a.getFlagMessageErrorNotification),
                (message = _a.message),
                (client = _a.client),
            ...
            case 2:
              _b.sent();
              successMessage = this.validateAndGetNotificationMessage(
                getFlagMessageSuccessNotification,
                [message],
              );
            ...
            case 3:
              e_1 = _b.sent();
              errorMessage = this.validateAndGetNotificationMessage(
                getFlagMessageErrorNotification,
                [message],
              );
              if (addNotification !== undefined) {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              ...
              (_a = this.props),
                (getMuteUserSuccessNotification =
                  _a.getMuteUserSuccessNotification),
                (getMuteUserErrorNotification =
                  _a.getMuteUserErrorNotification),
                (message = _a.message),
                (client = _a.client),
                (addNotification = _a.addNotification),
                (t = _a.t);
    ...
    _this.handleEdit = function(event) {
      var _a = _this.props,
        setEditingState = _a.setEditingState,
        message = _a.message;
    ...
    _this.handleReaction = function(reactionType, event) {
      return __awaiter(_this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              ...
              for (
                _i = 0, _a = this.props.message.own_reactions || [];
                _i < _a.length;
                _i++
              ) {
                reaction = _a[_i];
    ...
    _this.handleAction = function(name, value, event) {
      return __awaiter(_this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.props.channel.sendAction(messageID, formData),
              ];
            case 1:
              data = _a.sent();
    ...
    _this.handleRetry = function(message) {
      return __awaiter(_this, void 0, void 0, function() {
        return __generator(this, function(_a) {
    ...
    _this.getMessageActions = function() {
      var _a = _this.props,
        message = _a.message,
        messageActionsProps = _a.messageActions;
  ...
  Message.prototype.shouldComponentUpdate = function(nextProps) {
    ...
    if (
      !shouldUpdate &&
      !deep_equal_1.default(nextProps.readBy, this.props.readBy)
    ) {
      shouldUpdate = true;
      reason = 'readBy';
    }
