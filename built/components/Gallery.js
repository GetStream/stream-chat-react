...
var Gallery = /** @class */ (function(_super) {
      ...
      images.length > 3 &&
        react_1.default.createElement(
          'div',
          {
            ...
            onClick: function() {
              return _this.toggleModal(3);
            },
          },
          react_1.default.createElement('p', null, images.length - 3, ' more'),
        ),
      react_1.default.createElement(
        react_images_1.ModalGateway,
        null,
        this.state.modalIsOpen
          ? react_1.default.createElement(
              react_images_1.Modal,
              { onClose: this.toggleModal, closeOnBackdropClick: true },
  ...
  Gallery.propTypes = {
    images: prop_types_1.default.arrayOf(
