...
var ReactionSelector = /** @class */ (function(_super) {
  ...
  function ReactionSelector(props) {
    ...
    _this.showTooltip = function(e, users) {
                      ...
                      return __generator(this, function(_a) {
                        switch (_a.label) {
                          case 0:
                            return [
                              4 /*yield*/,
                              this.setTooltipPosition(target),
                            ];
                          case 1:
                            _a.sent();
    ...
    _this.setTooltipPosition = function(target) {
      return __awaiter(_this, void 0, void 0, function() {
        var container, tooltip, position;
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.getContainerDimensions()];
            case 1:
              container = _a.sent();
    ...
    _this.setArrowPosition = function(target) {
      return __awaiter(_this, void 0, void 0, function() {
    ...
    _this.renderReactionItems = function() {
      var _a = _this.props,
        reaction_counts = _a.reaction_counts,
      ...
      return _this.props.reactionOptions.map(function(reaction) {
        ...
        return react_1.default.createElement(
          'li',
          {
            ...
            onClick: _this.props.handleReaction.bind(_this, reaction.id),
          },
          Boolean(count) &&
          ...
          react_1.default.createElement(
            ...
            __assign({ emoji: reaction }, utils_1.emojiSetDef, {
