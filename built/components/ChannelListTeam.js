...
var str_chat__icon_chevron_down_svg_1 = __importDefault(
...
var ChannelListTeam = /** @class */ (function(_super) {
  ...
  ChannelListTeam.prototype.render = function() {
    var _a = this.props,
      ...
      LoadingErrorIndicator = _a.LoadingErrorIndicator,
      LoadingIndicator = _a.LoadingIndicator;
    if (this.props.error) {
      return react_1.default.createElement(LoadingErrorIndicator, {
            ...
            react_1.default.createElement(
              ...
              react_1.default.createElement(
                ...
                react_1.default.createElement('img', {
                  src: str_chat__icon_chevron_down_svg_1.default,
                }),
              ),
            ),
          ),
...
exports.ChannelListTeam = ChannelListTeam = context_1.withChatContext(
  ChannelListTeam,
);
