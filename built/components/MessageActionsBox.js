...
var MessageActionsBox = /** @class */ (function (_super) {
    ...
    MessageActionsBox.prototype.render = function () {
        var _a = this.props, handleFlag = _a.handleFlag, handleMute = _a.handleMute, handleEdit = _a.handleEdit, handleDelete = _a.handleDelete, getMessageActions = _a.getMessageActions, t = _a.t;
        var messageActions = getMessageActions();
        return (react_1.default.createElement("div", { className: "str-chat__message-actions-box\n          " + (this.props.open ? 'str-chat__message-actions-box--open' : '') + "\n          " + (this.props.mine ? 'str-chat__message-actions-box--mine' : '') + "\n          " + (this.state.reverse ? 'str-chat__message-actions-box--reverse' : '') + "\n        ", ref: this.actionsBoxRef },
            react_1.default.createElement("ul", { className: "str-chat__message-actions-list" },
                messageActions.indexOf(utils_1.MESSAGE_ACTIONS.flag) > -1 && (react_1.default.createElement("button", { onClick: handleFlag },
                    react_1.default.createElement("li", { className: "str-chat__message-actions-list-item" }, t('Flag')))),
                messageActions.indexOf(utils_1.MESSAGE_ACTIONS.mute) > -1 && (react_1.default.createElement("button", { onClick: handleMute },
                    react_1.default.createElement("li", { className: "str-chat__message-actions-list-item" }, t('Mute')))),
                messageActions.indexOf(utils_1.MESSAGE_ACTIONS.edit) > -1 && (react_1.default.createElement("button", { onClick: handleEdit },
                    react_1.default.createElement("li", { className: "str-chat__message-actions-list-item" }, t('Edit Message')))),
                messageActions.indexOf(utils_1.MESSAGE_ACTIONS.delete) > -1 && (react_1.default.createElement("button", { onClick: handleDelete },
                    react_1.default.createElement("li", { className: "str-chat__message-actions-list-item" }, t('Delete')))))));
    };
...
exports.MessageActionsBox = MessageActionsBox = context_1.withTranslationContext(MessageActionsBox);
