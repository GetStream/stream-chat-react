...
var ReactionsList = /** @class */ (function (_super) {
    ...
    function ReactionsList(props) {
        ...
        _this._renderReactions = function (reactions) {
            ...
            return Object.keys(reactionsByType).map(function (type) {
                return reactionsEmojis[type] ? (react_1.default.createElement("li", { key: reactionsEmojis[type].id },
                    react_1.default.createElement(emoji_mart_1.NimbleEmoji, __assign({ emoji: reactionsEmojis[type] }, utils_1.emojiSetDef, { size: 16, data: utils_1.emojiData })),
                    ' ',
                    "\u00A0")) : null;
            });
        };
    ...
    ReactionsList.prototype.render = function () {
        return (react_1.default.createElement("div", { className: "str-chat__reaction-list " + (this.props.reverse ? 'str-chat__reaction-list--reverse' : ''), onClick: this.props.onClick, ref: this.reactionList },
            react_1.default.createElement("ul", null,
                this._renderReactions(this.props.reactions),
                react_1.default.createElement("li", null,
                    react_1.default.createElement("span", { className: "str-chat__reaction-list--counter" }, this._getReactionCount())))));
    };
