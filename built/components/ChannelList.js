...
var ChannelList = /** @class */ (function (_super) {
    ...
    function ChannelList(props) {
        ...
        _this.queryChannels = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, options, filters, sort, setActiveChannelOnMount, offset, newOptions, channelPromise, channelQueryResponse_1, customActiveChannel, e_1;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, options = _a.options, filters = _a.filters, sort = _a.sort, setActiveChannelOnMount = _a.setActiveChannelOnMount;
                        offset = this.state.offset;
                        this.setState({ refreshing: true });
                        newOptions = __assign({}, options);
                        if (!options.limit)
                            newOptions.limit = 30;
                        channelPromise = this.props.client.queryChannels(filters, sort, __assign(__assign({}, newOptions), { offset: offset }));
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        channelQueryResponse_1 = channelPromise;
                        if (!utils_1.isPromise(channelQueryResponse_1)) return [3 /*break*/, 3];
                    ...
                    case 3:
                        this.setState(function (prevState) {
                            var channels = __spreadArrays(prevState.channels, channelQueryResponse_1);
                            return {
                                channels: channels,
                                loadingChannels: false,
                                offset: channels.length,
                                hasNextPage: channelQueryResponse_1.length >= newOptions.limit ? true : false,
                                refreshing: false,
                            };
                        });
                        // Set a channel as active and move it to the top of the list.
                        if (this.props.customActiveChannel) {
                            customActiveChannel = channelQueryResponse_1.filter(function (channel) { return channel.id === _this.props.customActiveChannel; })[0];
                            if (customActiveChannel) {
                                this.props.setActiveChannel(customActiveChannel, this.props.watchers);
                                this.moveChannelUp(customActiveChannel.cid);
                            }
                        }
                        else if (setActiveChannelOnMount &&
                            offset === 0 &&
        ...
        _this.handleEvent = function (e) { return __awaiter(_this, void 0, void 0, function () {
            var newChannels, channel_1, channel_2, channels, channelIndex, channels, channelIndex;
                    ...
                    case 0:
                        if (e.type === 'user.presence.changed') {
                            ...
                            newChannels = newChannels.map(function (channel) {
                                if (!channel.state.members[e.user.id])
                                    return channel;
                        ...
                        if (!(e.type === 'notification.message_new')) return [3 /*break*/, 3];
                        if (!(this.props.onMessageNew &&
                            typeof this.props.onMessageNew === 'function')) return [3 /*break*/, 1];
                        this.props.onMessageNew(this, e);
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.getChannel(e.channel.type, e.channel.id)];
                    case 2:
                        channel_1 = _a.sent();
                        // move channel to starting position
                        this.setState(function (prevState) { return ({
                            channels: lodash_uniqby_1.default(__spreadArrays([channel_1], prevState.channels), 'cid'),
                        }); });
                        _a.label = 3;
                    case 3:
                        if (!(e.type === 'notification.added_to_channel')) return [3 /*break*/, 6];
                        if (!(this.props.onAddedToChannel &&
                            typeof this.props.onAddedToChannel === 'function')) return [3 /*break*/, 4];
                        this.props.onAddedToChannel(this, e);
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.getChannel(e.channel.type, e.channel.id)];
                    case 5:
                        channel_2 = _a.sent();
                        this.setState(function (prevState) { return ({
                            channels: lodash_uniqby_1.default(__spreadArrays([channel_2], prevState.channels), 'cid'),
                        }); });
                        _a.label = 6;
                    case 6:
                        // remove from channel
                        if (e.type === 'notification.removed_from_channel') {
                            if (this.props.onRemovedFromChannel &&
                                typeof this.props.onRemovedFromChannel === 'function') {
                                this.props.onRemovedFromChannel(this, e);
                            }
                            else {
                                this.setState(function (prevState) {
                                    var channels = prevState.channels.filter(function (channel) { return channel.cid !== e.channel.cid; });
                                    return {
                                        channels: channels,
                                    };
                                });
                        ...
                        if (e.type === 'channel.updated') {
                            ...
                            channelIndex = channels.findIndex(function (channel) { return channel.cid === e.channel.cid; });
                            if (channelIndex > -1) {
                                channels[channelIndex].data = seamless_immutable_1.default(e.channel);
                                this.setState({
                                    channels: __spreadArrays(channels),
                                    channelUpdateCount: this.state.channelUpdateCount + 1,
                                });
                            }
                            if (this.props.onChannelUpdated &&
                        ...
                        if (e.type === 'channel.deleted') {
                            if (this.props.onChannelDeleted &&
                        ...
                        if (e.type === 'channel.truncated') {
                            ...
                            if (this.props.onChannelTruncated &&
        ...
        _this.getChannel = function (type, id) { return __awaiter(_this, void 0, void 0, function () {
            var channel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        _this.moveChannelUp = function (cid) {
            ...
            // get channel index
            var channelIndex = _this.state.channels.findIndex(function (channel) { return channel.cid === cid; });
            if (channelIndex <= 0)
                return;
        ...
        _this._renderChannel = function (item) {
            var _a = _this.props, Preview = _a.Preview, setActiveChannel = _a.setActiveChannel, channel = _a.channel, watchers = _a.watchers;
            if (!item)
                return;
            var props = {
                channel: item,
            ...
            return utils_2.smartRender(ChannelPreview_1.ChannelPreview, __assign({}, props));
        };
        _this._handleClickOutside = function (e) {
            if (_this.channelListRef &&
    ...
    ChannelList.prototype.componentDidMount = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.queryChannels()];
                    case 1:
                        _a.sent();
    ...
    ChannelList.prototype.componentDidUpdate = function (prevProps) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!deep_equal_1.default(prevProps.filters, this.props.filters)) return [3 /*break*/, 3];
    ...
    ChannelList.prototype.render = function () {
        var _this = this;
        var _a = this.props, List = _a.List, Paginator = _a.Paginator, EmptyStateIndicator = _a.EmptyStateIndicator;
        var _b = this.state, channels = _b.channels, loadingChannels = _b.loadingChannels, refreshing = _b.refreshing, hasNextPage = _b.hasNextPage;
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("div", { className: "str-chat str-chat-channel-list " + this.props.theme + " " + (this.props.navOpen ? 'str-chat-channel-list--open' : ''), ref: function (ref) { return (_this.channelListRef = ref); } },
                react_1.default.createElement(List, { loading: loadingChannels, error: this.state.error, channels: channels, setActiveChannel: this.props.setActiveChannel, activeChannel: this.props.channel, showSidebar: this.props.showSidebar, LoadingIndicator: this.props.LoadingIndicator, LoadingErrorIndicator: this.props.LoadingErrorIndicator }, !channels.length ? (react_1.default.createElement(EmptyStateIndicator, { listType: "channel" })) : (utils_2.smartRender(Paginator, {
                    loadNextPage: this.loadNextPage,
                    hasNextPage: hasNextPage,
                    refreshing: refreshing,
                    children: channels.map(function (item) { return _this._renderChannel(item); }),
                }))))));
    };
    ChannelList.propTypes = {
         ...
         * */
        Preview: prop_types_1.default.oneOfType([prop_types_1.default.node, prop_types_1.default.func]),
        /**
         ...
         */
        List: prop_types_1.default.oneOfType([prop_types_1.default.node, prop_types_1.default.func]),
        /**
         ...
         */
        Paginator: prop_types_1.default.oneOfType([prop_types_1.default.node, prop_types_1.default.func]),
        /**
