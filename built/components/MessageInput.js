...
var MessageInput = /** @class */ (function(_super) {
  ...
  function MessageInput(props) {
    ...
    _this.insertText = function(textToInsert) {
    ...
    _this.handleChange = function(event) {
      ...
      if (text) {
        stream_chat_1.logChatPromiseExecution(
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                this.props.doImageUploadRequest(file, this.props.channel),
              ];
            case 3:
              response = _a.sent();
              return [3 /*break*/, 6];
            case 4:
              return [4 /*yield*/, this.props.channel.sendImage(file)];
            case 5:
              response = _a.sent();
              _a.label = 6;
            case 6:
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                this.props.doFileUploadRequest(file, this.props.channel),
              ];
            case 3:
              response = _a.sent();
              return [3 /*break*/, 6];
            case 4:
              return [4 /*yield*/, this.props.channel.sendFile(file)];
            case 5:
              response = _a.sent();
              _a.label = 6;
            case 6:
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                react_file_utils_1.dataTransferItemsToFiles(items),
              ];
            case 1:
              fileLikes = _a.sent();
              if (fileLikes.length) {
    ...
    if (props.message) {
      ...
      for (
        var _b = 0, _c = props.message.mentioned_users;
        _b < _c.length;
        _b++
      ) {
        var mention = _c[_b];
  ...
  MessageInput.prototype.render = function() {
    ...
    return react_1.default.createElement(
      Input,
      __assign({}, this.props, this.state, handlers),
    );
  };
  MessageInput.propTypes = {
     ...
     *
     * */
    Input: prop_types_1.default.oneOfType([
...
exports.MessageInput = MessageInput = context_1.withChannelContext(
  MessageInput,
);
