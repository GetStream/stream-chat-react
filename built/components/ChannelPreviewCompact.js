...
var ChannelPreviewCompact = /** @class */ (function (_super) {
    ...
    ChannelPreviewCompact.prototype.render = function () {
        var unreadClass = this.props.unread_count >= 1
        ...
        return (react_1.default.createElement("button", { onClick: this.onSelectChannel, ref: this.channelPreviewButton, className: "str-chat__channel-preview-compact " + unreadClass + " " + activeClass },
            react_1.default.createElement("div", { className: "str-chat__channel-preview-compact--left" },
                react_1.default.createElement(Avatar_1.Avatar, { image: this.props.channel.data.image, size: 20 })),
            react_1.default.createElement("div", { className: "str-chat__channel-preview-compact--right" }, name)));
    };
