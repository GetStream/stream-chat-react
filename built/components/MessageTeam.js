...
var MessageTeam = /** @class */ (function (_super) {
    ...
    function MessageTeam() {
        ...
        _this.formatArray = function (arr) {
            var _a = _this.props, t = _a.t, client = _a.client;
            var outStr = '';
            var slicedArr = arr
                .filter(function (item) { return item.id !== client.user.id; })
        ...
        _this.renderStatus = function () {
            var _a = _this.props, readBy = _a.readBy, message = _a.message, threadList = _a.threadList, client = _a.client, lastReceivedId = _a.lastReceivedId, t = _a.t;
            if (!_this.isMine() || message.type === 'error') {
                return null;
            }
            var justReadByMe = readBy.length === 1 && readBy[0].id === client.user.id;
            if (message.status === 'sending') {
                return (react_1.default.createElement("span", { className: "str-chat__message-team-status" },
                    react_1.default.createElement(Tooltip_1.Tooltip, null, t('Sending...')),
                    react_1.default.createElement(LoadingIndicator_1.LoadingIndicator, { isLoading: true })));
            }
                ...
                return (react_1.default.createElement("span", { className: "str-chat__message-team-status" },
                    ...
                    readBy.length - 1 > 1 && (react_1.default.createElement("span", { className: "str-chat__message-team-status-number" }, readBy.length - 1))));
            }
    ...
    MessageTeam.prototype.renderAttachments = function (attachments) {
        var _a = this.props, Attachment = _a.Attachment, message = _a.message, handleAction = _a.handleAction;
        return attachments.map(function (attachment, index) { return (react_1.default.createElement(Attachment, { key: message.id + "-" + index, attachment: attachment, actionHandler: handleAction })); });
    };
    // eslint-disable-next-line
    MessageTeam.prototype.render = function () {
        var _a = this.props, message = _a.message, groupStyles = _a.groupStyles, editing = _a.editing, clearEditingState = _a.clearEditingState, updateMessage = _a.updateMessage, threadList = _a.threadList, initialMessage = _a.initialMessage, handleReaction = _a.handleReaction, channelConfig = _a.channelConfig, handleOpenThread = _a.handleOpenThread, Message = _a.Message, messageListRect = _a.messageListRect, onMentionsHoverMessage = _a.onMentionsHoverMessage, onMentionsClickMessage = _a.onMentionsClickMessage, unsafeHTML = _a.unsafeHTML, handleRetry = _a.handleRetry, getMessageActions = _a.getMessageActions, isMyMessage = _a.isMyMessage, handleFlag = _a.handleFlag, handleMute = _a.handleMute, handleEdit = _a.handleEdit, handleDelete = _a.handleDelete, t = _a.t, tDateTimeParser = _a.tDateTimeParser;
        ...
        var galleryImages = message.attachments &&
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("div", { className: "str-chat__message-team str-chat__message-team--" + groupStyles[0] + " str-chat__message-team--" + message.type + " " + (threadList ? 'thread-list' : '') + " str-chat__message-team--" + message.status, onMouseLeave: this.onMouseLeaveMessage },
                react_1.default.createElement("div", { className: "str-chat__message-team-meta" },
                    groupStyles[0] === 'top' ||
                        groupStyles[0] === 'single' ||
                        initialMessage ? (react_1.default.createElement(Avatar_1.Avatar, { image: message.user.image, name: message.user.name || message.user.id, size: 40 })) : (react_1.default.createElement("div", { style: { width: 40, marginRight: 0 } })),
                    react_1.default.createElement("time", { dateTime: message.created_at, title: message.created_at }, Boolean(Date.parse(message.created_at)) &&
                        tDateTimeParser(message.created_at).format('h:mmA'))),
                react_1.default.createElement("div", { className: "str-chat__message-team-group" },
                    (groupStyles[0] === 'top' ||
                        groupStyles[0] === 'single' ||
                        initialMessage) && (react_1.default.createElement("div", { className: "str-chat__message-team-author" },
                    ...
                    react_1.default.createElement("div", { className: "str-chat__message-team-content str-chat__message-team-content--" + groupStyles[0] + " str-chat__message-team-content--" + (message.text === '' ? 'image' : 'text') },
                        !initialMessage &&
                            message.status !== 'sending' &&
                            message.status !== 'failed' &&
                            message.type !== 'system' &&
                            message.type !== 'ephemeral' &&
                            message.type !== 'error' && (react_1.default.createElement("div", { className: "str-chat__message-team-actions" },
                            this.state.reactionSelectorOpen && (react_1.default.createElement(ReactionSelector_1.ReactionSelector, { handleReaction: handleReaction, latest_reactions: message.latest_reactions, reaction_counts: message.reaction_counts, detailedView: true, direction: reactionDirection, ref: this.reactionSelectorRef })),
                            channelConfig && channelConfig.reactions && (react_1.default.createElement("span", { title: "Reactions", dangerouslySetInnerHTML: {
                                    __html: reactionSvg,
                                }, onClick: this.onClickReactionsAction })),
                            !threadList && channelConfig && channelConfig.replies && (react_1.default.createElement("span", { title: "Start a thread", dangerouslySetInnerHTML: {
                                    __html: threadSvg,
                            ...
                            getMessageActions().length > 0 && (react_1.default.createElement("span", { onClick: this.onClickOptionsAction },
                                react_1.default.createElement("span", { title: "Message actions", dangerouslySetInnerHTML: {
                                        __html: optionsSvg,
                                    } }),
                                react_1.default.createElement(MessageActionsBox_1.MessageActionsBox, { getMessageActions: getMessageActions, Message: Message, open: this.state.actionsBoxOpen, message: message, messageListRect: messageListRect, mine: isMyMessage(message), handleFlag: handleFlag, handleMute: handleMute, handleEdit: handleEdit, handleDelete: handleDelete }))))),
                        react_1.default.createElement("span", { className: utils_1.isOnlyEmojis(message.text)
                                ? 'str-chat__message-team-text--is-emoji'
                                : '', onMouseOver: onMentionsHoverMessage, onClick: onMentionsClickMessage }, unsafeHTML ? (react_1.default.createElement("div", { dangerouslySetInnerHTML: { __html: message.html } })) : (utils_1.renderText(message))),
                        ...
                        message.latest_reactions &&
                            ...
                            message.text !== '' && (react_1.default.createElement(SimpleReactionsList_1.SimpleReactionsList, { reaction_counts: message.reaction_counts, handleReaction: handleReaction, reactions: message.latest_reactions })),
                        message.status === 'failed' && (react_1.default.createElement("button", { className: "str-chat__message-team-failed", onClick: handleRetry.bind(this, message) },
                    ...
                    message.latest_reactions &&
                        message.latest_reactions.length !== 0 &&
                        message.text === '' && (react_1.default.createElement(SimpleReactionsList_1.SimpleReactionsList, { reaction_counts: message.reaction_counts, handleReaction: handleReaction, reactions: message.latest_reactions })),
                    !threadList && (react_1.default.createElement(MessageRepliesCountButton_1.MessageRepliesCountButton, { onClick: handleOpenThread, reply_count: message.reply_count }))))));
    };
...
exports.MessageTeam = MessageTeam = context_1.withTranslationContext(MessageTeam);
