...
var List = /** @class */ (function (_super) {
    ...
    function List() {
        ...
        _this.getPositionInList = function () {
            ...
            if (!selectedItem)
                return 0;
            return values.findIndex(function (a) { return _this.getId(a) === _this.getId(selectedItem); });
        };
        ...
        _this.modifyText = function (value) {
            if (!value)
                return;
            var _a = _this.props, onSelect = _a.onSelect, getTextToReplace = _a.getTextToReplace, getSelectedItem = _a.getSelectedItem;
        ...
        _this.scroll = function (e) {
            ...
            _this.selectItem(values[newPosition], [listener_1.KEY_CODES.DOWN, listener_1.KEY_CODES.UP].includes(code));
        };
    ...
    List.prototype.componentDidMount = function () {
        this.listeners.push(listener_1.default.add([listener_1.KEY_CODES.DOWN, listener_1.KEY_CODES.UP], this.scroll), listener_1.default.add([listener_1.KEY_CODES.ENTER, listener_1.KEY_CODES.TAB], this.onPressEnter));
    ...
    List.prototype.UNSAFE_componentWillReceiveProps = function (_a) {
        ...
        var newValues = values.map(function (val) { return _this.getId(val); }).join('');
    ...
    List.prototype.render = function () {
        var _this = this;
        var _a = this.props, values = _a.values, component = _a.component, style = _a.style, itemClassName = _a.itemClassName, className = _a.className, itemStyle = _a.itemStyle;
        return (react_1.default.createElement("ul", { className: "rta__list " + (className || ''), style: style },
            react_1.default.createElement("li", { className: "rta__list-header", dangerouslySetInnerHTML: {
                    __html: this.renderHeader(this.props.value),
                } }),
            values.map(function (item) { return (react_1.default.createElement(Item_1.default, { key: _this.getId(item), innerRef: function (ref) {
                    _this.itemsRef[_this.getId(item)] = ref;
                }, selected: _this.isSelected(item), item: item, className: itemClassName, style: itemStyle, onClickHandler: _this.onPressEnter, onSelectHandler: _this.selectItem, component: component })); })));
    };
    return List;
