...
var react_textarea_autosize_1 = __importDefault(
...
var ReactTextareaAutocomplete = /** @class */ (function(_super) {
  ...
  function ReactTextareaAutocomplete(props) {
    ...
    _this._changeHandler = function(e) {
      ...
      if (
        ...
        var _c = textarea_caret_1.default(textarea, selectionEnd),
          newTop = _c.top,
          newLeft = _c.left;
        _this.setState({
  ...
  ReactTextareaAutocomplete.prototype.componentDidMount = function() {
    var _this = this;
    listener_1.default.add(listener_1.KEY_CODES.ESC, function() {
      return _this._closeAutocomplete();
    });
    listener_1.default.add(listener_1.KEY_CODES.SPACE, function() {
      return _this._onSpace();
    });
    var listenerIndex = listener_1.default.add(
      listener_1.KEY_CODES.ENTER,
      function(e) {
  ...
  ReactTextareaAutocomplete.prototype.UNSAFE_componentWillReceiveProps = function(
    nextProps,
  ) {
