...
var MessageSimple = /** @class */ (function(_super) {
  ...
  function MessageSimple() {
    ...
    _this.renderMessageActions = function() {
      ...
      return react_1.default.createElement(
        ...
        react_1.default.createElement(MessageActionsBox_1.MessageActionsBox, {
          Message: Message,
  ...
  MessageSimple.prototype.render = function() {
    var _a = this.props,
      ...
      actionsEnabled = _a.actionsEnabled,
      messageListRect = _a.messageListRect,
    ...
    return react_1.default.createElement(
      ...
      editing &&
        react_1.default.createElement(
          Modal_1.Modal,
          { open: editing, onClose: clearEditingState },
          react_1.default.createElement(
            MessageInput_1.MessageInput,
            __assign(
              {
          ...
          !message.text &&
            react_1.default.createElement(
              ...
              hasReactions &&
                ...
                react_1.default.createElement(ReactionsList_1.ReactionsList, {
...
exports.MessageSimple = MessageSimple = context_1.withTranslationContext(
  MessageSimple,
);
