...
exports.translationContext = {
    ...
    tDateTimeParser: function (date) { return Dayjs(date); },
};
...
exports.MessageMock = {
    ...
    canDeleteMessage: function () { return true; },
    canEditMessage: function () { return true; },
    getMessageActions: function () { return []; },
};
