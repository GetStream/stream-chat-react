...
var Channel = /** @class */ (function(_super) {
  ...
  Channel.prototype.render = function() {
    ...
    return react_1.default.createElement(
      ChannelInner,
      __assign({}, this.props, { key: this.props.channel.cid }),
    );
  };
  Channel.propTypes = {
...
var ChannelInner = /** @class */ (function(_super) {
  ...
  function ChannelInner(props) {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              if (this.state.threadLoadingMore) return [2 /*return*/];
              this.setState({
    ...
    _this.updateMessage = function(updatedMessage, extraState) {
      ...
      _this.setState(
        __assign({ messages: channel.state.messages }, extraState),
      );
    };
    ...
    _this.createMessagePreview = function(
      text,
      attachments,
      parent,
      mentioned_users,
    ...
    _this.editMessage = function(updatedMessage) {
      if (_this.props.doUpdateMessageRequest) {
        return Promise.resolve(
          _this.props.doUpdateMessageRequest(
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.props.doSendMessageRequest(
            ...
            case 2:
              ...
              return [3 /*break*/, 5];
            case 3:
              return [4 /*yield*/, this.props.channel.sendMessage(messageData)];
            case 4:
              messageResponse = _a.sent();
              _a.label = 5;
            case 5:
        ...
        return __generator(this, function(_d) {
          switch (_d.label) {
            case 0:
              ...
              messagePreview = this.createMessagePreview(
                text,
                attachments,
                parent,
                mentioned_users,
    ...
    _this.retrySendMessage = function(message) {
      return __awaiter(_this, void 0, void 0, function() {
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
      ...
      _this.setState(function(prevState) {
        ...
        if (!prevState.eventHistory[lastMessageId])
          return __assign(__assign({}, prevState), {
            eventHistory: __assign(
              __assign({}, prevState.eventHistory),
              ((_a = {}), (_a[lastMessageId] = [e]), _a),
            ),
          });
        return __assign(__assign({}, prevState), {
          eventHistory: __assign(
            __assign({}, prevState.eventHistory),
            ((_b = {}),
            (_b[lastMessageId] = __spreadArrays(
              prevState.eventHistory[lastMessageId],
              [e],
            )),
            _b),
          ),
      ...
      return __awaiter(_this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              // prevent duplicate loading events...
              if (this.state.loadingMore) return [2 /*return*/];
    ...
    _this.getContext = function() {
      return __assign(__assign({}, _this.state), {
        client: _this.props.client,
        channel: _this.props.channel,
        Message: _this.props.Message,
        Attachment: _this.props.Attachment,
        multipleUploads: _this.props.multipleUploads,
        ...
        onMentionsClick: _this._onMentionsHoverOrClick,
        onMentionsHover: _this._onMentionsHoverOrClick,
      });
    };
    ...
    _this._loadMoreFinishedDebounced = debounce_1.default(
      _this.loadMoreFinished,
      2000,
      {
        leading: true,
        trailing: true,
    ...
    // hard limit to prevent you from scrolling faster than 1 page per 2 seconds
    _this._loadMoreThreadFinishedDebounced = debounce_1.default(
      _this.loadMoreThreadFinished,
      2000,
      {
        leading: true,
        trailing: true,
  ...
  ChannelInner.prototype.render = function() {
    ...
    if (this.state.error) {
      core = react_1.default.createElement(LoadingErrorIndicator, {
        error: this.state.error,
      });
    } else if (this.state.loading) {
      core = react_1.default.createElement(LoadingIndicator, {
        size: 25,
        isLoading: true,
      });
      ...
      core = react_1.default.createElement(
        context_1.ChannelContext.Provider,
    ...
    return react_1.default.createElement(
      'div',
      { className: 'str-chat str-chat-channel ' + this.props.theme },
      core,
    );
  };
...
exports.Channel = Channel = context_1.withChatContext(
  context_1.withTranslationContext(Channel),
);
