...
var ChannelPreview = /** @class */ (function (_super) {
    ...
    function ChannelPreview(props) {
        ...
        _this.getLatestMessage = function () {
            var _a = _this.props, channel = _a.channel, t = _a.t;
    ...
    ChannelPreview.prototype.render = function () {
        ...
        return (react_1.default.createElement(Preview, __assign({}, props, { latestMessage: this.getLatestMessage(), active: this.props.activeChannel.cid === this.props.channel.cid })));
    };
...
exports.ChannelPreview = ChannelPreview = context_1.withTranslationContext(ChannelPreview);
