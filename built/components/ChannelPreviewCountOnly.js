...
var ChannelPreviewCountOnly = /** @class */ (function (_super) {
    ...
    ChannelPreviewCountOnly.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: unreadClass },
            react_1.default.createElement("button", { onClick: this.props.setActiveChannel.bind(this, this.props.channel) },
                ' ',
                name,
                " ",
