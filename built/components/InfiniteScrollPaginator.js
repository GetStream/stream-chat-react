...
var InfiniteScrollPaginator = /** @class */ (function (_super) {
    ...
    InfiniteScrollPaginator.prototype.render = function () {
        var _a = this.props, LoadingIndicator = _a.LoadingIndicator, loadNextPage = _a.loadNextPage, hasNextPage = _a.hasNextPage, refreshing = _a.refreshing, reverse = _a.reverse, threshold = _a.threshold;
        return (react_1.default.createElement(InfiniteScroll_1.default, { loadMore: loadNextPage, hasMore: hasNextPage, isLoading: refreshing, isReverse: reverse, threshold: threshold, useWindow: false, loader: react_1.default.createElement("div", { className: "str-chat__infinite-scroll-paginator", key: "loadingindicator" },
                react_1.default.createElement(LoadingIndicator, null)) }, this.props.children));
    };
