 ...
 */
var MessageInputLarge = /** @class */ (function (_super) {
    __extends(MessageInputLarge, _super);
    function MessageInputLarge() {
        ...
        _this.renderEmojiPicker = function () {
            if (_this.props.emojiPickerIsOpen) {
                return (react_1.default.createElement("div", { className: "str-chat__input--emojipicker", ref: _this.props.emojiPickerRef },
                    react_1.default.createElement(emoji_mart_1.Picker, { native: true, emoji: "point_up", title: "Pick your emoji\u2026", onSelect: _this.props.onSelectEmoji, color: "#006CFF", showPreview: false, useButton: true, emojisToShowFilter: utils_1.filterEmoji })));
            }
        };
        _this.constructTypingString = function (dict) {
            var t = _this.props.t;
    ...
    MessageInputLarge.prototype.render = function () {
        var _this = this;
        var t = this.props.t;
        var SendButton = this.props.SendButton;
        return (react_1.default.createElement("div", { className: "str-chat__input-large" },
            react_1.default.createElement(react_file_utils_1.ImageDropzone, { accept: this.props.acceptedFiles, multiple: this.props.multipleUploads, disabled: this.props.numberOfUploads >= this.props.maxNumberOfFiles
                ...
                react_1.default.createElement("div", { className: "str-chat__input" },
                    this.renderUploads(),
                    this.renderEmojiPicker(),
                    react_1.default.createElement("div", { className: "str-chat__input--textarea-wrapper" },
                        react_1.default.createElement(ChatAutoComplete_1.ChatAutoComplete, { users: this.props.getUsers(), commands: this.props.getCommands(), innerRef: this.props.textareaRef, handleSubmit: function (e) { return _this.props.handleSubmit(e); }, onChange: this.props.handleChange, onSelectItem: this.props.onSelectItem, value: this.props.text, rows: 1, maxRows: this.props.maxRows, placeholder: t('Type your message'), onPaste: this.props.onPaste, grow: this.props.grow, disabled: this.props.disabled, additionalTextareaProps: this.props.additionalTextareaProps }),
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement("div", { className: "str-chat__input-footer" },
                        react_1.default.createElement("span", { className: "str-chat__input-footer--count " + (!this.props.watcher_count
                                ? 'str-chat__input-footer--count--hidden'
                                : '') }, t('{{ watcherCount }} online', {
                            watcherCount: this.props.watcher_count,
                        })),
                        react_1.default.createElement("span", { className: "str-chat__input-footer--typing" }, this.constructTypingString(this.props.typing)))))));
    };
...
var MessageInputLargeWithContext = context_1.withTranslationContext(MessageInputLarge);
