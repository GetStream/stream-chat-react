...
var MessageInputLarge = /** @class */ (function(_super) {
  ...
  function MessageInputLarge() {
    ...
    _this.renderUploads = function() {
      return react_1.default.createElement(
        react_1.default.Fragment,
        null,
        _this.props.imageOrder.length > 0 &&
          react_1.default.createElement(react_file_utils_1.ImagePreviewer, {
        ...
        _this.props.fileOrder.length > 0 &&
          react_1.default.createElement(react_file_utils_1.FilePreviewer, {
      ...
      if (_this.props.emojiPickerIsOpen) {
        return react_1.default.createElement(
          ...
          react_1.default.createElement(emoji_mart_1.Picker, {
            ...
            showPreview: false,
            useButton: true,
            emojisToShowFilter: utils_1.filterEmoji,
          }),
        );
      }
    };
  ...
  MessageInputLarge.prototype.render = function() {
    ...
    return react_1.default.createElement(
      ...
      react_1.default.createElement(
        react_file_utils_1.ImageDropzone,
        {
        ...
        react_1.default.createElement(
          ...
          react_1.default.createElement(
            ...
            react_1.default.createElement(ChatAutoComplete_1.ChatAutoComplete, {
            ...
            react_1.default.createElement(
              react_file_utils_1.FileUploadButton,
              {
                multiple: this.props.multipleUploads,
                disabled:
                  this.props.numberOfUploads >= this.props.maxNumberOfFiles
            ...
            SendButton &&
              react_1.default.createElement(SendButton, {
  ...
  MessageInputLarge.propTypes = {
     ...
     * */
    SendButton: prop_types_1.default.oneOfType([
...
var MessageInputLargeWithContext = context_1.withTranslationContext(
  MessageInputLarge,
);
