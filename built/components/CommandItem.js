...
var CommandItem = /** @class */ (function (_super) {
    ...
    CommandItem.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: "str-chat__slash-command" },
            react_1.default.createElement("span", { className: "str-chat__slash-command-header" },
                react_1.default.createElement("strong", null, c.name),
                " ",
                c.args),
            react_1.default.createElement("br", null),
            react_1.default.createElement("span", { className: "str-chat__slash-command-description" }, c.description)));
    };
