...
var ChatAutoComplete = /** @class */ (function (_super) {
    ...
    ChatAutoComplete.prototype.getTriggers = function () {
        ...
        return {
            ...
            '@': {
                ...
                callback: function (item) { return _this.props.onSelectItem(item); },
            },
            '/': {
                dataProvider: function (q, text) {
                    ...
                    var selectedCommands = _this.props.commands.filter(function (c) { return c.name.indexOf(q) !== -1; });
    ...
    ChatAutoComplete.prototype.render = function () {
        ...
        return (react_1.default.createElement(AutoCompleteTextarea_1.default, { loadingComponent: LoadingIndicator_1.LoadingIndicator, trigger: this.getTriggers(), replaceWord: this.emojiReplace, minChar: 0, maxRows: this.props.maxRows, innerRef: innerRef &&
                (function (ref) {
                    innerRef.current = ref;
                }), onFocus: this.props.onFocus, rows: this.props.rows, className: "str-chat__textarea__textarea", containerClassName: "str-chat__textarea", dropdownClassName: "str-chat__emojisearch", listClassName: "str-chat__emojisearch__list", itemClassName: "str-chat__emojisearch__item", placeholder: this.props.placeholder, onChange: this.props.onChange, handleSubmit: this.props.handleSubmit, onPaste: this.props.onPaste, value: this.props.value, grow: this.props.grow, disabled: this.props.disabled, additionalTextareaProps: this.props.additionalTextareaProps }));
    };
