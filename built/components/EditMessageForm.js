 ...
 */
var EditMessageForm = /** @class */ (function (_super) {
    __extends(EditMessageForm, _super);
        ...
        _this.renderEmojiPicker = function () {
            ...
            if (_this.props.emojiPickerIsOpen) {
                return (react_1.default.createElement("div", { className: "str-chat__small-message-input-emojipicker", ref: _this.props.emojiPickerRef },
                    react_1.default.createElement(emoji_mart_1.Picker, { native: true, emoji: "point_up", title: t('Pick your emoji'), onSelect: _this.props.onSelectEmoji, color: "#006CFF", showPreview: false, emojisToShowFilter: utils_1.filterEmoji })));
            }
        };
        return _this;
    }
    EditMessageForm.prototype.render = function () {
        var t = this.props.t;
        return (react_1.default.createElement("div", { className: "str-chat__edit-message-form" },
            react_1.default.createElement(react_file_utils_1.ImageDropzone, { accept: this.props.acceptedFiles, multiple: this.props.multipleUploads, disabled: this.props.numberOfUploads >= this.props.maxNumberOfFiles
                ...
                react_1.default.createElement("form", { onSubmit: this.props.handleSubmit },
                    this.renderEmojiPicker(),
                    this.renderUploads(),
                    this.props.emojiPickerIsOpen && (react_1.default.createElement("div", { className: "str-chat__input--emojipicker", ref: this.props.emojiPickerRef },
                        react_1.default.createElement(emoji_mart_1.Picker, { native: true, emoji: "point_up", title: t('Pick your emoji'), onSelect: this.props.onSelectEmoji, color: "#006CFF", emojisToShowFilter: utils_1.filterEmoji }))),
                    react_1.default.createElement(ChatAutoComplete_1.ChatAutoComplete, { users: this.props.getUsers(), commands: this.props.getCommands(), innerRef: this.props.textareaRef, handleSubmit: this.props.handleSubmit, onChange: this.props.handleChange, onSelectItem: this.props.onSelectItem, value: this.props.text, rows: 1, maxRows: this.props.maxRows, onPaste: this.props.onPaste, grow: this.props.grow, additionalTextareaProps: this.props.additionalTextareaProps }),
                    react_1.default.createElement("div", { className: "str-chat__message-team-form-footer" },
                        react_1.default.createElement("div", { className: "str-chat__edit-message-form-options" },
                            react_1.default.createElement("span", { className: "str-chat__input-emojiselect", onClick: this.props.openEmojiPicker },
                            ...
                            react_1.default.createElement(react_file_utils_1.FileUploadButton, { multiple: this.props.multipleUploads, disabled: this.props.numberOfUploads >= this.props.maxNumberOfFiles
                                ...
                                react_1.default.createElement("span", { className: "str-chat__input-fileupload" },
                                    react_1.default.createElement("svg", { width: "14", height: "14", xmlns: "http://www.w3.org/2000/svg" },
                        ...
                        react_1.default.createElement("div", null,
                            react_1.default.createElement("button", { onClick: this.props.clearEditingState }, t('Cancel')),
                            react_1.default.createElement("button", { type: "submit" }, t('Send'))))))));
    };
...
exports.EditMessageForm = EditMessageForm = context_1.withTranslationContext(EditMessageForm);
