...
var Chat = /** @class */ (function (_super) {
    ...
    function Chat(props) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, channel.query({ watch: true, watchers: watchers })];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2:
        ...
        _this.getContext = function () { return ({
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (i18nInstance && i18nInstance instanceof Streami18n_1.Streami18n) {
    ...
    Chat.prototype.render = function () {
        if (!this.state.t)
            return null;
        return (react_1.default.createElement(context_1.ChatContext.Provider, { value: this.getContext() },
            react_1.default.createElement(context_1.TranslationContext.Provider, { value: {
                    t: this.state.t,
