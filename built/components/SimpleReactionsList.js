...
var SimpleReactionsList = /** @class */ (function (_super) {
    ...
    function SimpleReactionsList() {
        ...
        _this.getReactionCount = function () {
            ...
            if (reaction_counts !== null &&
                ...
                count = 0;
                Object.keys(reaction_counts).map(function (key) { return (count += reaction_counts[key]); });
            }
            return count;
        };
        ...
        _this.getReactionsByType = function (reactions) {
            ...
            reactions.map(function (item) {
                if (reactionsByType[item.type] === undefined) {
                    ...
                    return (reactionsByType[item.type] = __spreadArrays(reactionsByType[item.type], [
                        item,
                    ]));
                }
            });
        ...
        _this.renderReactions = function (reactions) {
            ...
            return Object.keys(reactionsByType).map(function (type, i) { return (react_1.default.createElement("li", { className: "str-chat__simple-reactions-list-item", key: reactionsByType[type][0].id + "-" + i, onClick: function (e) { return _this.handleReaction(e, type); } },
                react_1.default.createElement("span", { onMouseEnter: function () { return _this.setUsernames(type); } },
                    react_1.default.createElement(emoji_mart_1.NimbleEmoji, __assign({ emoji: reactionsEmojis[type] }, utils_1.emojiSetDef, { size: 13, data: utils_1.emojiData })),
                    "\u00A0"))); });
        };
        ...
        _this.setUsernames = function (type) {
            ...
            _this.setState({
                users: users,
            }, function () { return _this.showTooltip(); });
        };
        _this.renderUsernames = function (users) { return users.join(', '); };
        return _this;
    }
    SimpleReactionsList.prototype.render = function () {
        ...
        return (react_1.default.createElement("ul", { className: "str-chat__simple-reactions-list", onMouseLeave: this.hideTooltip },
            this.state.showTooltip && (react_1.default.createElement("div", { className: "str-chat__simple-reactions-list-tooltip", ref: this.reactionSelectorTooltip },
                react_1.default.createElement("div", { className: "arrow" }),
                this.renderUsernames(this.state.users))),
            this.renderReactions(reactions),
            reactions.length !== 0 && (react_1.default.createElement("li", { className: "str-chat__simple-reactions-list-item--last-number" }, this.getReactionCount()))));
    };
