...
var ChannelPreviewLastMessage = /** @class */ (function (_super) {
    ...
    ChannelPreviewLastMessage.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: "str-chat__channel-preview " + unreadClass + " " + activeClass },
            react_1.default.createElement("button", { onClick: this.onSelectChannel, ref: this.channelPreviewButton },
                this.props.unread >= 1 && (react_1.default.createElement("div", { className: "str-chat__channel-preview--dot" })),
                react_1.default.createElement(Avatar_1.Avatar, { image: this.props.channel.data.image }),
                react_1.default.createElement("div", { className: "str-chat__channel-preview-info" },
                    react_1.default.createElement("span", { className: "str-chat__channel-preview-title" }, name),
                    react_1.default.createElement("span", { className: "str-chat__channel-preview-last-message" }, !this.props.channel.state.messages[0]
                        ? t('Nothing yet...')
                        : truncate_1.default(this.props.latestMessage, {
                            length: this.props.latestMessageLength,
                        })),
                    this.props.unread >= 1 && (react_1.default.createElement("span", { className: "str-chat__channel-preview-unread-count" }, this.props.unread))))));
    };
...
exports.ChannelPreviewLastMessage = ChannelPreviewLastMessage = context_1.withTranslationContext(ChannelPreviewLastMessage);
