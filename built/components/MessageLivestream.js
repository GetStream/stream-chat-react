  ...
  MessageLivestream.prototype.render = function() {
    ...
    return react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        {
          className:
            'str-chat__message-livestream str-chat__message-livestream--' +
            groupStyles[0] +
        ...
        this.state.reactionSelectorOpen &&
          react_1.default.createElement(ReactionSelector_1.ReactionSelector, {
            reverse: false,
...
exports.MessageLivestream = MessageLivestream = context_1.withTranslationContext(
  MessageLivestream,
);
