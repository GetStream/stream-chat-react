...
var str_chat__connection_error_svg_1 = __importDefault(require("../assets/str-chat__connection-error.svg"));
...
var ChatDown = /** @class */ (function (_super) {
    ...
    ChatDown.prototype.render = function () {
        var _a = this.props, image = _a.image, type = _a.type, text = _a.text, t = _a.t;
        return (react_1.default.createElement("div", { className: "str-chat__down" },
            react_1.default.createElement(LoadingChannels_1.LoadingChannels, null),
            react_1.default.createElement("div", { className: "str-chat__down-main" },
