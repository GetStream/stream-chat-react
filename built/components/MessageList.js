...
var MessageList = /** @class */ (function (_super) {
    ...
    function MessageList(props) {
        ...
        _this.keypress = function (event) {
            if (event.keyCode === AutoCompleteTextarea_1.KEY_CODES.ESC && _this.state.editing) {
        ...
        _this.insertDates = function (messages) {
            ...
            for (var _i = 0, _a = messages.entries(); _i < _a.length; _i++) {
                var _b = _a[_i], i = _b[0], message = _b[1];
        ...
        _this.goToNewMessages = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.scrollToBottom()];
                    case 1:
                        _a.sent();
                        this.setState({
        ...
        _this.getReadStates = function (messages) {
            ...
            for (var _a = 0, _b = Object.values(_this.props.read); _a < _b.length; _a++) {
                var readState = _b[_a];
                ...
                if (userLastReadMsgId != null) {
                    readData[userLastReadMsgId] = __spreadArrays(readData[userLastReadMsgId], [
                        readState.user,
                    ]);
                }
            }
        ...
        _this.userScrolledUp = function () { return _this.scrollOffset > 310; };
    ...
    MessageList.prototype.componentDidUpdate = function (prevProps, prevState, snapshot) {
    ...
    MessageList.prototype.render = function () {
        ...
        var _a = this.props, TypingIndicator = _a.TypingIndicator, DateSeparator = _a.dateSeparator, HeaderComponent = _a.HeaderComponent, EmptyStateIndicator = _a.EmptyStateIndicator, t = _a.t;
        // sort by date
        ...
        for (var _i = 0, allMessages_1 = allMessages; _i < allMessages_1.length; _i++) {
            ...
            if (message.type === 'message.date') {
                ...
                elements.push(react_1.default.createElement("li", { key: message.date.toISOString() + '-i' },
                    react_1.default.createElement(DateSeparator, { date: message.date })));
            }
            else if (message.type === 'channel.intro') {
                elements.push(react_1.default.createElement("li", { key: "intro" },
                    react_1.default.createElement(HeaderComponent, null)));
            }
            else if (message.type === 'channel.event' ||
                message.type === 'system') {
                MessageSystem &&
                    elements.push(react_1.default.createElement("li", { key: message.type === 'system'
                            ? message.created_at
                            : message.type === 'channel.event'
                                ? message.event.created_at
                                : '' },
                        react_1.default.createElement(MessageSystem, { message: message })));
            }
                ...
                elements.push(react_1.default.createElement("li", { className: "str-chat__li str-chat__li--" + groupStyles, key: message.id || message.created_at, ref: this.messageRefs[message.id] },
                    react_1.default.createElement(Message_1.Message, { client: this.props.client, openThread: this.props.openThread, members: this.props.members, watchers: this.props.watchers, message: message, groupStyles: groupStyles, readBy: readBy, lastReceivedId: lastReceivedId === message.id ? lastReceivedId : null, editing: !!(this.state.editing && this.state.editing === message.id), clearEditingState: this.clearEditingState, setEditingState: this.setEditingState, messageListRect: this.state.messageListRect, channel: this.props.channel, threadList: this.props.threadList, retrySendMessage: this.props.retrySendMessage, addNotification: this.addNotification, updateMessage: this.props.updateMessage, removeMessage: this.props.removeMessage, Message: this.props.Message, unsafeHTML: this.props.unsafeHTML, Attachment: this.props.Attachment, onMentionsClick: this.props.onMentionsClick, onMentionsHover: this.props.onMentionsHover, messageActions: this.props.messageActions, additionalMessageInputProps: this.props.additionalMessageInputProps, getFlagMessageSuccessNotification: this.props.getFlagMessageSuccessNotification, getFlagMessageErrorNotification: this.props.getFlagMessageErrorNotification, getMuteUserSuccessNotification: this.props.getMuteUserSuccessNotification, getMuteUserErrorNotification: this.props.getMuteUserErrorNotification })));
            }
        }
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("div", { className: "str-chat__list " + (this.props.threadList ? 'str-chat__list--thread' : ''), ref: this.messageList }, !elements.length ? (react_1.default.createElement(EmptyStateIndicator, { listType: "message" })) : (react_1.default.createElement(ReverseInfiniteScroll_1.ReverseInfiniteScroll, { loadMore: this._loadMore, hasMore: this.props.hasMore, isLoading: this.props.loadingMore, listenToScroll: this.listenToScroll, useWindow: false, loader: react_1.default.createElement(Center, { key: "loadingindicator" },
                    react_1.default.createElement(LoadingIndicator_1.LoadingIndicator, { size: 20 })) },
                react_1.default.createElement("ul", { className: "str-chat__ul" }, elements),
                this.props.TypingIndicator && (react_1.default.createElement(TypingIndicator, { typing: this.props.typing, client: this.props.client })),
                react_1.default.createElement("div", { key: "bottom", ref: this.bottomRef })))),
            react_1.default.createElement("div", { className: "str-chat__list-notifications" },
                this.state.notifications.map(function (notification) { return (react_1.default.createElement(Notification, { active: true, key: notification.id, type: notification.type }, notification.text)); }),
                react_1.default.createElement(Notification, { active: !this.state.online, type: "error" }, t('Connection failure, reconnecting now...')),
                react_1.default.createElement(MessageNotification_1.MessageNotification, { showNotification: this.state.newMessagesNotification, onClick: function () { return _this.goToNewMessages(); } }, t('New Messages!')))));
    };
    MessageList.propTypes = {
         ...
         * */
        TypingIndicator: prop_types_1.default.oneOfType([prop_types_1.default.node, prop_types_1.default.func]),
        /**
         ...
         * */
        dateSeparator: prop_types_1.default.oneOfType([prop_types_1.default.node, prop_types_1.default.func]),
         ...
         */
        MessageSystem: prop_types_1.default.oneOfType([prop_types_1.default.node, prop_types_1.default.func]),
        /**
         * The UI Indicator to use when MessagerList or ChannelList is empty
         * */
        EmptyStateIndicator: prop_types_1.default.oneOfType([prop_types_1.default.node, prop_types_1.default.func]),
        /**
         * Component to render at the top of the MessageList
         * */
        HeaderComponent: prop_types_1.default.oneOfType([prop_types_1.default.node, prop_types_1.default.func]),
        /** **Available from [channel context](https://getstream.github.io/stream-chat-react/#channel)** */
...
exports.MessageList = MessageList = context_1.withChannelContext(context_1.withTranslationContext(MessageList));
var Center = function (_a) {
    var children = _a.children;
    return (react_1.default.createElement("div", { className: "str-chat__list__center" }, children));
};
var Notification = function (_a) {
    var children = _a.children, active = _a.active, type = _a.type;
    if (active) {
        return (react_1.default.createElement("div", { className: "str-chat__custom-notification notification-" + type }, children));
    }
    return null;
};
