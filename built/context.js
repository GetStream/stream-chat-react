...
function withChatContext(OriginalComponent) {
  var ContextAwareComponent = function ContextComponent(props) {
    return react_1.default.createElement(
      exports.ChatContext.Consumer,
      null,
      function(context) {
        var mergedProps = __assign(__assign({}, context), props);
        return react_1.default.createElement(
          OriginalComponent,
          __assign({}, mergedProps),
        );
      },
    );
  };
...
function withChannelContext(OriginalComponent) {
  var ContextAwareComponent = function ContextComponent(props) {
    return react_1.default.createElement(
      exports.ChannelContext.Consumer,
      null,
      function(channelContext) {
        return react_1.default.createElement(
          OriginalComponent,
          __assign({}, channelContext, props),
        );
      },
    );
  };
...
exports.TranslationContext = react_1.default.createContext({
  ...
  tDateTimeParser: function(input) {
    return dayjs_1.default(input);
  },
});
function withTranslationContext(OriginalComponent) {
  var ContextAwareComponent = function ContextComponent(props) {
    return react_1.default.createElement(
      exports.TranslationContext.Consumer,
      null,
      function(translationContext) {
        return react_1.default.createElement(
          OriginalComponent,
          __assign({}, translationContext, props),
        );
      },
    );
  };
