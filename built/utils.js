...
exports.defaultMinimalEmojis = [
  __assign(
    __assign(
      { id: 'like', name: 'like', colons: ':+1:', sheet_x: 0, sheet_y: 0 },
      exports.commonEmoji,
    ),
    exports.emojiSetDef,
  ),
  __assign(
    __assign(
      { id: 'love', name: 'love', colons: ':heart:', sheet_x: 1, sheet_y: 2 },
      exports.commonEmoji,
    ),
    exports.emojiSetDef,
  ),
  __assign(
    __assign(
      { id: 'haha', name: 'haha', colons: ':joy:', sheet_x: 1, sheet_y: 0 },
      exports.commonEmoji,
    ),
    exports.emojiSetDef,
  ),
  ...
  __assign(
    __assign(
      { id: 'sad', name: 'sad', colons: ':pensive:', sheet_x: 0, sheet_y: 1 },
      exports.commonEmoji,
    ),
    exports.emojiSetDef,
  ),
  __assign(
    __assign(
      { id: 'angry', name: 'angry', colons: ':angry:', sheet_x: 1, sheet_y: 1 },
      exports.commonEmoji,
    ),
    exports.emojiSetDef,
  ),
...
exports.renderText = function(message) {
  ...
  for (var _i = 0, urls_1 = urls; _i < urls_1.length; _i++) {
    ...
    var displayLink = truncate_1.default(
    ...
    var mkdown =
      '[' + displayLink + '](' + urlInfo.protocol + urlInfo.encoded + ')';
  ...
  return react_1.default.createElement(with_html_1.default, {
