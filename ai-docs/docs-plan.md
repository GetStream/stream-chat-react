...
- Phase: post-snapshot docs maintenance against audited head `9877da511183c5149959583bc4f11d7aa616f87f`
...
- New SDK changes after the audited head should be mined from `9877da511183c5149959583bc4f11d7aa616f87f..HEAD`, then folded back into both trackers before related docs edits are made
...
- Future mining starting point: review `stream-chat-react` diff `9877da511183c5149959583bc4f11d7aa616f87f..HEAD`, then map any confirmed changes back to `v13.14.2` before updating `breaking-changes.md` and this file
...
- no new post-snapshot docs fallout is currently open from the `d2513383..9877da51` window
- the next docs pass should start from `9877da51..HEAD`
