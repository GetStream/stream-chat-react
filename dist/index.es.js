...
var MessageTextComponent = function MessageTextComponent(props) {
  ...
  }) : messageText, hasReactions && !showDetailedReactions && /*#__PURE__*/React.createElement(ReactionsList, {
    reactions: message.latest_reactions,
    reaction_counts: message.reaction_counts,
    onClick: onReactionListClick,
    reverse: true
  }), showDetailedReactions && /*#__PURE__*/React.createElement(ReactionSelector, {
...
var MessageSimple = function MessageSimple(props) {
  ...
  })), hasReactions && !showDetailedReactions && /*#__PURE__*/React.createElement(ReactionsList, {
    reactions: message.latest_reactions,
    reaction_counts: message.reaction_counts,
    onClick: onReactionListClick,
    reverse: true
...
var MessageTeam = function MessageTeam(props) {
  ...
  }), (message === null || message === void 0 ? void 0 : message.latest_reactions) && message.latest_reactions.length !== 0 && message.text !== '' && /*#__PURE__*/React.createElement(ReactionsList, {
    reaction_counts: message.reaction_counts,
    handleReaction: propHandleReaction || handleReaction,
    reactions: message.latest_reactions
...
var EmptyStateIndicator$1 = /*#__PURE__*/React.memo(EmptyStateIndicator);
...
var Message$2 = /*#__PURE__*/React.memo(function Message(_ref2) {
  ...
  }, /*#__PURE__*/React.createElement("strong", null, message.user.name ? message.user.name : 'unknown')), /*#__PURE__*/React.createElement("span", {
...
var FastMessageList = function FastMessageList(_ref3) {
  ...
  var itemRenderer = useCallback(function (message, prevMessage) {
    ...
    return /*#__PURE__*/React.createElement(Message$2, {
      client: client,
      message: message,
  ...
  if (!messages.length) return /*#__PURE__*/React.createElement(EmptyStateIndicator$1, {
    listType: "message"
  });
  return /*#__PURE__*/React.createElement("div", {
...
var MemoizeFastMessageList = /*#__PURE__*/React.memo(FastMessageList, deepequal);
function FastMessageListWithContext(props) {
  return /*#__PURE__*/React.createElement(ChannelContext.Consumer, null, function (_ref5) {
    var messages = _ref5.messages,
        client = _ref5.client,
        loadMore = _ref5.loadMore,
        hasMore = _ref5.hasMore,
        loadingMore = _ref5.loadingMore;
    return /*#__PURE__*/React.createElement(MemoizeFastMessageList, _extends({
      messages: messages,
      client: client,
      loadMore: loadMore,
      hasMore: hasMore,
